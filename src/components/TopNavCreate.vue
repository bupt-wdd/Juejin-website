...
<template>
  <div>
    <button class="createBtn">
      ...
      <div v-if="createMenuOpened" class="create-menu">
        <ul>
          <li><a @click="intoMarkdown()">写文章</a></li>
          <li><a>发沸点</a></li>
          <li><a>写代码</a></li>
          <li><a>草稿箱</a></li>
        </ul>
